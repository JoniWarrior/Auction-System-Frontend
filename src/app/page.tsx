...
export default function Home() {
  ...
  const linkHref = user?.role === "seller" ? "/my-auctions-seller" : "/auctions";
    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-r from-purple-700 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Discover Unique Treasures & <br />Win Amazing Auctions</h1>
          <p className="text-xl mb-10 max-w-2xl mx-auto">Bid on exclusive items from around the world. Everything from rare collectibles to everyday essentials.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href={linkHref} className="bg-white text-purple-700 font-semibold py-3 px-8 rounded-lg hover:bg-gray-100 transition duration-300 flex items-center justify-center">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-10">
            ...
            <Link href="/auctions" className="text-purple-600 hover:text-purple-800 font-medium flex items-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Create an account and explore thousands of unique items up for auction.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Enter your maximum bid and let our system automatically compete for you.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">If you have the highest bid when the auction ends, the item is yours!</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-500 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-10 max-w-2xl mx-auto">Join thousands of bidders discovering amazing items every day.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/signup" className="bg-white text-purple-700 font-semibold py-3 px-8 rounded-lg hover:bg-gray-100 transition duration-300">
              Create Account
            </Link>
            <Link href="/auctions" className="bg-transparent border-2 border-white text-white font-semibold py-3 px-8 rounded-lg hover:bg-white hover:text-purple-700 transition duration-300">
              Browse Auctions
            </Link>
          </div>
        </div>
